...
use An3\Couchdb\Model;
use An3\Couchdb\Relations\BelongsTo;
use An3\Couchdb\Relations\BelongsToMany;
use An3\Couchdb\Relations\HasMany;
use An3\Couchdb\Relations\HasOne;
use An3\Couchdb\Relations\MorphTo;
